      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <span><h2>Antrian Pasien <?php echo "$jenis_poli"; ?></h2></span>
            </div>
            <section class="content">
              <!-- Main row -->
              <div class="row">
                              ...
                              <div class="box-body">
                                <table class="table table-bordered">
                                  ...
                                  while($data_diagnosa = mysqli_fetch_array ($query_diagnosa)) {
                                    ...
                                    $select_pasien = "SELECT * FROM `pasien` WHERE  level>1 && no_rekam_medis = '$no_rekam_medis' " ;
                                    ...
                                    while ($data_pasien = mysqli_fetch_array ($query_pasien)) {
                                      ...
                                      <tr>
                                        ...
                                        <?php if ($level == 2) {?>
                                          <td>
                                            <form action="pengkajian_awal.php?jenis_poli=<?php echo "$jenis_poli"; ?>" method="post">
                                        ...
                                        <?php }elseif ($level == 3) { ?>
                                          <td><span class="badge bg-orange"> Sedang Diperiksa Dokter </span></td>
                                        <?php }elseif ($level == 43) { ?>
                                          <td><span class="badge bg-orange"> Selesai Tes LAB </span></td>
                                        <?php }elseif ($level == 4) { ?>
                                        ...
                                        <?php } elseif ($level == 6) {
                                           ...
                                           $query_sel_rujukan = mysqli_query($conn, $select_rujukan);
                                           $data_rujukan = mysqli_fetch_array($query_sel_rujukan);
                                           $status_rujukan = $data_rujukan['status_rujukan'];
                                           if ($status_rujukan==1) {
                                             echo "<td><span class='badge bg-blue'> Selesai </span></td>";
                                           } else {
                                             echo "
                                             <td>
                                               <form action='cek_rujukan.php?jenis_poli=$jenis_poli' method='post'>
                                                 <input type='hidden' name='id_diagnosa' value=$id_diagnosa>
                                                 <button type='submit' class='badge bg-orange'>Rujukan</button>
                                               </form>
                                             </td>
                                             ";
                                           }
