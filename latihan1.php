...
$alamat_rumah= $data_pasien['id_alamat'];
$select_pembiayaan = "SELECT * FROM `pembiayaan` WHERE id_diagnosa = '$id_diagnosa'";
...
$nomor_bpjs = $data_pembiayaan['nomor_asuransi'];
...
$pdf->Cell(4,5,' : ',0,0);
$pdf->Cell(15,5,$jenis_pembiayaan,0,1);
$pdf->Cell(15);
$pdf->Cell(43,5,'Agama',0,0);
$pdf->Cell(4,5,' : ',0,0);
$pdf->Cell(40,5,$agama,0,0);
$pdf->Cell(43,5,'Nomor BPJS',0,0);
$pdf->Cell(4,5,' : ',0,0);
$pdf->Cell(15,5,$nomor_bpjs,0,1);
...
$pdf->Cell(5,6,' :',1,0);
$pdf->Cell(15,6,$tekanan_darah.' k/m',1,0);
$pdf->Cell(12,6,'Nadi',1,0);
$pdf->Cell(5,6,' :',1,0);
$pdf->Cell(15,6,$nadi.'mnHg',1,0);
$pdf->Cell(12,6,'Suhu ',1,0);
$pdf->Cell(5,6,' :',1,0);
$pdf->Cell(13,6,$suhu.' C',1,0);
$pdf->Cell(20,6,'Respirasi',1,0);
$pdf->Cell(5,6,' :',1,0);
...
$total = 35000;
  ...
  $pdf->SetFont('Arial','',10);
  $pdf->Cell(6);
  $pdf->Cell(55,6,'Obat',1,0);
  $pdf->Cell(5,6,' :',1,0);
  $pdf->Cell(130,6,'Aturan Pemakaian',1,1);
  ...
  while ($data_resep = mysqli_fetch_array($query_resep)) {
    ...
    $pdf->Cell(5,6,' :',0,0);
    $pdf->Cell(130,6,$aturan_pemakaian,1,1);
  }
