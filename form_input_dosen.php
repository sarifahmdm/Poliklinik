  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <ol class="breadcrumb">
        ...
        <li class="active">Input Pasien Baru</li>
      </ol>
    </section>
    <br>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <span><h2>Form input pasien baru</h2></span>
            </div>
            <section class="content">
              <!-- Main row -->
              <div class="row">
                        ...
                        <div class="col-md-12">
                          <div>
                            ...
                            <div >
                              <!-- /.box-header -->
                              <!-- form start -->
                              <form class="form-horizontal" method="post" action="proses_form_input_dosen.php">
                                <div class="box-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="box-footer">
                                      <button type="submit" class="btn btn-info pull-right swalDefaultSuccess">Save</button>
                                    </div>
                                  </form>
                                  </div>
                                </div>
