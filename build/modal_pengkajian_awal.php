  ...
  <div class="modal-dialogdatapasien ">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="proses_modal_pengkajian_awal.php?jenis_poli=<?php echo $jenis_poli; ?>">
                ...
                <tbody>
                    <td>
                      <div class="form-group">
                        <div class="col-sm-10">
                          <textarea name="keluhan_utama" class="form-control" rows="3"><?php echo "$keluhan_utama";?></textarea>
                        </div>
                      </div>
                    </td>
                    <td>
                      <table>
                        <tr>
                          ...
                          <td>
                            <div class="col-sm-10">
                              <input type="text" name="rp_sekarang" class="form-control" value="<?php echo "$rp_sekarang"; ?>" >
                              </input>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <div class="col-sm-10">
                              <input type="text" name="rp_dahulu" class="form-control" value="<?php echo "$rp_dahulu";?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-sm-10">
                              <input type="text" name="rp_keluarga" class="form-control" value="<?php echo "$rp_keluarga";?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-sm-10">
                              <input type="text" name="rp_pribadi_sosial" class="form-control" value="<?php echo "$rp_pribadi_sosial";?>">
                     ...
                     ?>
                      <table>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-xs-10">
                              <input type="number" name="nadi" class="form-control" value="<?php echo "$nadi";?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-xs-10">
                              <input type="number" name="suhu" class="form-control" value="<?php echo "$suhu";?>">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="col-xs-10">
                              <input type="number" name="respirasi" class="form-control" value="<?php echo "$respirasi"; ?>">
