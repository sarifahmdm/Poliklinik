      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="hidden-xs">Dokter <?php echo "$jenis_poli";?></span>
          </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Dokter <?php echo "$jenis_poli"; ?></p>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview menu-open">
          <a href="index_dokter.php?jenis_poli=<?php echo "$jenis_poli";?>">
        ...
        <li>
          <a href="antrian_dokter.php?jenis_poli=<?php echo "$jenis_poli";?>">
            <i class="fa fa fa-book text-orange"></i>
            <span>Antrian Pasien</span>
            <span class="pull-right-container">
              <?php
                $jumlah = 0;
                $select_pasien = "SELECT * FROM `pasien` WHERE level = '3'";
        ...
        <li>
          <a href="data_RM_pasien_dokter.php?jenis_poli=<?php echo "$jenis_poli";?>">
            <i class="fa fa-book text-blue"></i> <span>Riwayat Pasien Terdaftar</span>
            <span class="pull-right-container">
            </span>
          </a>
